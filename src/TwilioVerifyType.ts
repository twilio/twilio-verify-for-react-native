...
export type TwilioVerifyType = {
  ...
  getAllChallenges(challengeListPayload: ChallengeListPayload): Promise<ChallengeList>;
  updateChallenge(updateChallengePayload: UpdateChallengePayload): Promise<void>;
